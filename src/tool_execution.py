...
async def _execute_tool_block_impl(
    ...
    from src.tool_implementations import (
        ...
        do_manage_calendar, do_manage_external_tasks,
    ...
    elif tool == "manage_external_tasks":
        desc = "manage_external_tasks"
        result = await do_manage_external_tasks(content, owner=owner)
